...
public class NonTeachStaffDetailDTO {

	private String nonTeachStaffUserId;
	...
	public String getNonTeachStaffUserId() {
		return nonTeachStaffUserId;
	}

	public void setNonTeachStaffUserId(String nonTeachStaffUserId) {
		this.nonTeachStaffUserId = nonTeachStaffUserId;
	}
